...
namespace DAL
{
    public class DAL_SOBH : KetNoi
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT MABH 'Mã bảo hiểm', MANV 'Mã nhân viên', FORMAT(NGAYCAPSO, 'dd/MM/yyyy') 'Ngày cấp sổ', NOICAPSO 'Nơi cấp sổ', GHICHU 'Ghi chú' FROM SOBH", connection);
